        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 sign-up" style="text-align: center;">
                    ...
                    <p>If you want to register as a Student click on Student register button otherwise click on owner register button.</p><br><br>
                    <button type="submit" class="btn btn-info"  onclick="window.location.href='tenant-register.php'" style="width:200px;">Student Register</button>
