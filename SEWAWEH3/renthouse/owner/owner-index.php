...
<div id="map_canvas"></div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
              <label for="ward_no">address:</label>
              <input type="text" class="form-control" id="ward_no" placeholder="Enter Address" name="ward_no">
            </div>
            <div class="form-group">
              <label for="tole">Lot</label>
              <input type="text" class="form-control" id="tole" placeholder="Enter Lot" name="tole">
            </div>
            <div class="form-group">
